...
class Kuule_Savel():
    ...
    def Aloita(self):
        ...
        self.__Tarkista_Taso()  # Tarkistetaan mikä pelitaso on asetettu
        ...
        while True:
            ...
            for tapahtuma in pygame.event.get():
                ...
                if tapahtuma.type == pygame.MOUSEBUTTONDOWN and pygame.mouse.get_pressed(3)[0] == True:    # Vasen hiiren painike alas
                    if self.valmistaudu == False and self.soita_savelet == False and self.pelitaso_vaihda == False:
                        # Tarkista onko vastaus oikein vai väärin
            ...
            # Tarkista ja vaihda pelin tila
            self.__Tarkista_Pelin_Tila()  
    ...
    def __Tarkista_Vastaus(self, savel):
        if apufunktiot.Savel_Tekstina(self.midi)[0] == savel:
            ...
            if savel not in self.vastauspainikkeet_vaarin:
                self.vastauspainikkeet_vaarin.append(savel)
            self.oikein_vaarin_teksti = "Väärin"
            self.oikein_vaarin_ajastin = 60
            self.vaarin_maara += 1
            self.arvausmaara -= 1

    def __Tarkista_Pelin_Tila(self):
        # Tason vaihtamisvaihe
    ...
    def __Tarkista_Taso(self):
        ...
        if self.pelitaso == 1:
            ...
            self.pelitaso_vaihda = True
            Vastauspainikkeiden_Savelet(["C", "D", "E", "F"])
            ...
            self.pelitaso_vaihda = True
            Vastauspainikkeiden_Savelet(["C", "D", "E", "F", "G"])
            ...
            self.pelitaso_vaihda = True
            Vastauspainikkeiden_Savelet(["C", "D", "E", "F", "G", "A"])
            ...
            self.pelitaso_vaihda = True
            Vastauspainikkeiden_Savelet(["C", "D", "E", "F", "G", "A", "H"])
            self.midi_alue = (60, 71)
            self.ilman_korotusta = True
            self.valmistaudu = False
            self.soita_savelet = False
            ...
            self.pelitaso_vaihda = True
            Vastauspainikkeiden_Savelet(["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "H"])
            self.midi_alue = (60, 71)
            self.ilman_korotusta = False
            self.valmistaudu = False
            self.soita_savelet = False
